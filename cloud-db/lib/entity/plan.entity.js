...
exports.Plan = Plan;
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)("increment", { unsigned: true }),
...
__decorate([
    (0, typeorm_1.Index)("IDX_PROFILE_ID"),
    (0, typeorm_1.Column)({ nullable: true, unsigned: true }),
    __metadata("design:type", Number)
], Plan.prototype, "profileId", void 0);
__decorate([
